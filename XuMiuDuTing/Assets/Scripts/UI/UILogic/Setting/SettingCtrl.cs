...
namespace Yu
{
    public class SettingCtrl : UICtrlBase
    {
        ...
        private static void SliderOnValueChangeBGM(float value)
        {
        ...
        /// </summary>
        /// <param name="value"></param>
        private static void SliderOnValueChangeSe(float value)
        {
        ...
        /// </summary>
        /// <param name="value"></param>
        private static void SliderOnValueChangeVoice(float value)
        {
