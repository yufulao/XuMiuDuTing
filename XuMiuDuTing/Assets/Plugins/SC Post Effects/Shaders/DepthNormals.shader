Shader "Hidden/SC Post Effects/DepthNormals"
{
	...
	// Reconstruct view-space position from SCREEN_COORDS and depth.
	...
	float4 Frag(Varyings input) : SV_Target
	{
		...
		SCREEN_COORDS = SCREEN_COORDS * float2(1.0, -1.0) + float2(0.0, 1.0);
		#endif
		
		return AccurateReconstruction(SCREEN_COORDS);
	}
